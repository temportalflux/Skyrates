...
}]\mbox{[}Handshake.\-3\mbox{]} Sent to tell server that we have accepted the client I\-D (\hyperlink{class_game_state}{Game\-State} updates can begin) \end{description}
\end{Desc}
