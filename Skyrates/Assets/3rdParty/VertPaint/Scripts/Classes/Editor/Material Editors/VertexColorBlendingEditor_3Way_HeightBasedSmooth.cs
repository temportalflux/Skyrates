...
class VertexColorBlendingEditor_3Way_HeightBasedSmooth : VertexColorBlendingEditorBase
{
    ...
    MaterialProperty heightShift1, heightShift2, heightShift3, transitionSmoothness;
