...
namespace MomentsEditor
{
	...
	public sealed class RecorderEditor : Editor
	{
        ...
        void OnEnable()
		{
		    ...
		    m_GifPath = serializedObject.FindProperty("m_GifPath");
        }
		...
		public override void OnInspectorGUI()
		{
		    ...
		    EditorGUILayout.PropertyField(m_GifPath, new GUIContent("Gif Path", "The relative path to the save folder for gifs from Assets."));
