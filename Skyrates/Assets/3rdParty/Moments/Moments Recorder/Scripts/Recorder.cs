...
namespace Moments
{
	...
	public sealed class Recorder : MonoBehaviour
	{
		...
		void Init()
		{
			...
			{
				#if UNITY_EDITOR
				SaveFolder = Application.dataPath + this.m_GifPath; // Defaults to the asset folder in the editor for faster access to the gif file
				#else
				SaveFolder = Application.persistentDataPath + this.m_GifPath;
				#endif
			}
		}
