Shader "VertPaint/3-Way Vertex Color Blending (Height Based Smooth)" 
{
	Properties 
	{
	...
	SubShader
	{
		...
		void surf(Input IN, inout SurfaceOutputStandard o)
		{
			...
			o.Albedo = heightblend(albedo1, height1, albedo2, height2, albedo3, height3);

			o.Normal = heightblend(normal1, height1, normal2, height2, normal3, height3);
			
			o.Metallic = heightblend(mshao1.r, height1, mshao2.r, height2, mshao3.r, height3);
			
			o.Smoothness = clamp(heightblend(mshao1.g * _Smoothness1, height1, mshao2.g * _Smoothness2, height2, mshao3.g * _Smoothness3, height3), 0, 1);
			
			o.Occlusion = heightblend(mshao1.a, height1, mshao2.a, height2, mshao3.a, height3);
		}
	...
	CustomEditor "VertexColorBlendingEditor_3Way_HeightBasedSmooth"
}
